...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default='FC100/save/proto-5')
    ...
    test_set = MiniImageNet(root=root_directory, split="test1", training=False, transform=transform)
    ...
    filename = f'FC100/5shotCSVfile_test/result/InfoTest_test=150.csv'
