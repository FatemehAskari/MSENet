...
class PrototypicalNetworks1(nn.Module):
    def __init__(self,backbone:nn.Module):
        super(PrototypicalNetworks1, self).__init__()
...
class PrototypicalNetworks2(nn.Module):
    def __init__(self,backbone:nn.Module):
        super(PrototypicalNetworks2, self).__init__()
        self.backbone=backbone
...
class PrototypicalNetworks4(nn.Module):
    def __init__(self,backbone:nn.Module,weightlearnable,weight,gamma1,gamma2):
        super(PrototypicalNetworks4, self).__init__()
        self.backbone=backbone
        self.weightlearnable=weightlearnable
        self.weight=weight
