...
if __name__ == '__main__':
    ...
    parser.add_argument('--load', default='save/baseline+multiscal/1shot/newprototypical_lr=_0.0001.pth')
    ...
    filename1 = f'CUB/baseline/InfoTest_5shot_mean.csv'
    filename2 = f'CUB/baseline+multiscale/InfoTest_5shot_mean.csv'
    filename3 = f'CUB/baseline+multiscale+weight/InfoTest_5shot_mean.csv'
    
    filename4 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.0_0.csv'
    filename5 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.0_1.csv'
    
    
    filename6 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.1_0.csv'
    filename7 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.1_1.csv'
    
    
    filename8 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.2_0.csv'
    filename9 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.2_1.csv'
    
    filename10 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.3_1.csv'
    filename11 = f'CUB/baseline+multiscale+weight+attention/InfoTest_5shot_mean0.3_0.csv'
    ...
    print(f'mean: {np.mean(m1)} , var: {np.var(m1)}')
    print(f'mean: {np.mean(m2)} , var: {np.var(m2)}') 
    print(f'mean: {np.mean(m3)} , var: {np.var(m3)}')
