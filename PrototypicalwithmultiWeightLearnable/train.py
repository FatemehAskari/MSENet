...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='relu_MiniImageNet/save/proto-1_change')
    ...
    root_directory = "../data/mini_imagenet/miniimagenet"
    filename = 'relu_MiniImageNet/1shotCSVfile_train_change/Allinfoweight_1shot_change.csv'
    ...
    with open(filename, 'w', newline='') as file:
        ...
        for i in range (len(weights)):
            ...
            optimizer = optim.Adam(model_true.parameters(), lr=0.00002)
            ...
            # add optimizer and loss
            criterion = nn.CrossEntropyLoss()
            optimizer = optim.Adam(model_false.parameters(), lr=0.00002)
