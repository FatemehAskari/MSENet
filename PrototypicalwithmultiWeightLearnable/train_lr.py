...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='relu_MiniImageNet/save/proto-5_change')
    ...
    val_set = MiniImageNet(root=root_directory, split="test", training=False, transform=transform)  
    ...
    filename = 'relu_MiniImageNet/5shotCSVfile_train_change/Allinfoweight_5shot_change.csv'
    ...
    with open(filename, 'w', newline='') as file:
        ...
        for i in range (len(weights)):
            ...
            regular_params = [param for param in model_true.parameters() if not any(param is weight_param for weight_param in [model_true.weight_1, model_true.weight_2, model_true.weight_3, model_true.weight_4, model_true.weight_5])]


            optimizer = optim.Adam([
                {'params': regular_params},  
                {'params': [model_true.weight_1, model_true.weight_2, model_true.weight_3, model_true.weight_4, model_true.weight_5], 'lr': 0.001}
            ], lr=0.0001)
            ...
            print(weight_after1_true , weight_after2_true ,
                  weight_after3_true ,weight_after4_true ,
                  weight_after5_true)
