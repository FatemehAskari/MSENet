...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-path', default='MiniImageNet/save/proto-57')
    ...
    for j in range(len(gamma_list)-1,-1,-1):
        save_path = os.path.join(args.save_path, str(gamma_list[j]))
        if not os.path.exists(save_path):
            os.makedirs(save_path)
            
        filename = f'result2/5shot${gamma_list[j]}_ffffff.csv'
        column_names = ['weight1', 'weight2', 'weight3', 'weight4', 'weight5','weight_change1', 
                        ...
                        'changegamma1','changegamma2','lr1','accuracy_true']
        with open(filename, 'w', newline='') as file:
            ...
            for i in range (len(weights)):
                convolutional_network=resnet18(pretrained=True)
                convolutional_network.fc=nn.Flatten()
                model_true=PrototypicalNetworks(convolutional_network,weightlearnable=True,weight=weights[i],gamma1=gamma_list[j],
                ...
                print(model_true.gamma1.item(),model_true.gamma2.item())
                    ...
                    # column_names = ['weight1', 'weight2', 'weight3', 'weight4', 'weight5','weight_change1', 
                    #     'weight_change2', 'weight_change3', 'weight_change4', 'weight_change5','gamma1','gamma2','changegamma1','changegamma2','lr1','accuracy_true',
                    #     'gamma1_false','gamma2_false','changegamma1_false','changegamma2_false','lr2','accuracy_false']
